 /**
  * This is a reference implementation of the FIO API parser.
  * It is not used in the project, but it is taken from a Google Sheet Apps Script project which is 
  * the original implementation of this project's functionality.
  * 
  * 
  * 
  * 
...
function fetchTransactions() {
  ...
  //const fetchURl = `https://www.fio.cz/ib_api/rest/periods/${READONLY_TOKEN}/${dateFrom}/${dateTo}/transactions.${RESPONSE_FORMAT}`
  // fetch only transactions since last api call
  //const fetchUrl = `https://www.fio.cz/ib_api/rest/last/${READONLY_TOKEN}/transactions.${RESPONSE_FORMAT}`
